...
const COLORS = ['#0749BF', '#FFCC29', '#E63946', '#36C0E8', '#ffffff', '#ffd95e', '#003893']
...
.confetti-star {
  position: absolute;
  color: #FFCC29;
  text-shadow: 0 0 8px rgba(255, 204, 41, 0.9), 0 0 16px rgba(255, 204, 41, 0.5);
...
@keyframes confettiFall {
  ...
  100% {
    transform: translateY(110vh) translateX(var(--drift)) rotate(calc(var(--rotation) + 1080deg));
    opacity: 0.3;
  }
}
